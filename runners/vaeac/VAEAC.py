...
class VAEAC(Module):
    ...
    def batch_vlb(self, batch, mask):
        ...
        """
        # print("batch_vlb")
        #  print(list(batch[0].detach().cpu().numpy()))
        #  print(list(mask[0].detach().cpu().numpy()))
        ...
        # print("kl", kl)
        # print("prior_regularization", prior_regularization)
        # print("batch_vlb", rec_loss - kl + prior_regularization)
